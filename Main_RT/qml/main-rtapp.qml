...
//							}
            ...
            case "dropper status changed":
                {
                    if (!didx)
                        break;

                    str = decodeURIComponent( Qt.atob(array_str[ didx ]) );
                    Web.confirmationNotice( subject_type, str );
                    //print("confirmation: " + str);

//							<?xml version="1.0" encoding="utf-8" standalone="yes"?>
//							<notice status="rejected|accepted">[strDescr]</notice>
