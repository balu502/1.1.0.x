...
TARGET = analyser_PeaksArea
TEMPLATE = lib
CONFIG += dll
DEFINES += ANALYSER_PEAKSAREA_LIBRARY
include (../../../config.pro)
...
SOURCES += analyser_peaksarea.cpp \
    shapefactory.cpp

HEADERS += analyser_peaksarea.h\
        analyser_peaksarea_global.h \
    shapefactory.h
...
#OUT
TARGET = $$qtLibraryTarget(analyser_PeaksArea)
DLLDESTDIR = ../../../$${CURRENT_BUILD}/analyser_plugins
TRANSLATIONS = translations/analyser_peaksarea_ru.ts\
                translations/analyser_peaksarea_en.ts
