...
SOURCES += quality_pcr.cpp
HEADERS += quality_pcr.h\
        quality_pcr_global.h
...
#out
TARGET = $$qtLibraryTarget(test_quality)
DLLDESTDIR = ../../../$${CURRENT_BUILD}/test_plugins
TRANSLATIONS = translations/test_quality_ru.ts\
                translations/test_quality_en.ts
