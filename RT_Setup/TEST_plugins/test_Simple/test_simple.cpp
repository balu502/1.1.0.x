...
extern "C" TEST_SIMPLESHARED_EXPORT Test_Interface* __stdcall createTest_plugin()
{
    return(new Test_Simple());
}
...
//---
//-----------------------------------------------------------------------------
void* Test_Simple::Create_Win(void *pobj, void *main)
{
...
//---
//-----------------------------------------------------------------------------
void Test_Simple::Change_TabIndex(int index)
{
...
//--- Reserve(void *p)
//-----------------------------------------------------------------------------
void Test_Simple::Reserve(void *p)
{
...
//--- Disable_Action()
//-----------------------------------------------------------------------------
void Test_Simple::Disable_Action()
{
    // Header
...
//--- GetInformation
//-----------------------------------------------------------------------------
void Test_Simple::GetInformation(QVector<QString> *info)
{    
    info->append("0x0000");
    info->append(tr("Preliminary analysis"));
}
//-----------------------------------------------------------------------------
//--- readCommonSettings()
//-----------------------------------------------------------------------------
void Test_Simple::readCommonSettings()
{
    QString text;
    ...
    CommonSettings->beginGroup("Common");
        ...
        if(translator.load(":/translations/test_simple_" + text + ".qm"))
        {
...
//--- Set_Test
//-----------------------------------------------------------------------------
void Test_Simple::Set_Test(std::string xml, std::string name)
{
    int i,j,k,m,n;
    int value;
    int id_ch;
    ...
    header_Test->Load_NewTest(QString::fromStdString(name), GetRandomString(), 0x0000);
...
//-----------------------------------------------------------------------------
void Test_Simple::Get_Test(string *xml, string *name)
{
...
//-----------------------------------------------------------------------------
void Test_Simple::fill_Test(rt_Test *ptest)
{
...
//--- create_Common()
//-----------------------------------------------------------------------------
void Test_Simple::create_Common(QWidget *parent)
{
...
//--- create_HeaderTest()
//-----------------------------------------------------------------------------
void Test_Simple::create_HeaderTest(QWidget *parent)
{
    header_Test = new Header_Test(parent);
    active_ch = header_Test->active_Channels;
    header_Test->method_analysis = tr("Preliminary analysis");
}
//-----------------------------------------------------------------------------
//--- create_Program()
//-----------------------------------------------------------------------------
void Test_Simple::create_Program(QWidget *parent)
{
    Level_Program.clear();
...
//-----------------------------------------------------------------------------
void Test_Simple::Open_Program(QString fn)
{
    int i;
    QList<QTreeWidgetItem*> list_item;
    rt_Protocol *prot_temp;
