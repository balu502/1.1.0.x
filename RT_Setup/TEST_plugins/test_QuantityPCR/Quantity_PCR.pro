...
SOURCES += quantity_pcr.cpp
HEADERS += quantity_pcr.h\
        quantity_pcr_global.h
...
#out
TARGET = $$qtLibraryTarget(test_quantity)
DLLDESTDIR = ../../../$${CURRENT_BUILD}/test_plugins
TRANSLATIONS = translations/test_quantity_ru.ts\
                translations/test_quantity_en.ts
