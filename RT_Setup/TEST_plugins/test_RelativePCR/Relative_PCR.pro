#-------------------------------------------------
#
# Project created by QtCreator 2021-11-08
#
#-------------------------------------------------
...
SOURCES += relative_pcr.cpp
HEADERS += relative_pcr.h\
        relative_pcr_global.h
...
#out
TARGET = $$qtLibraryTarget(test_relative)
DLLDESTDIR = ../../../$${CURRENT_BUILD}/test_plugins
TRANSLATIONS = translations/test_relative_ru.ts\
                translations/test_relative_en.ts
