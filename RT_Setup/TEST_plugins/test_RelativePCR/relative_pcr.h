#ifndef RELATIVE_PCR_H
#define RELATIVE_PCR_H
...
#define  Method "Relative_PCR"

typedef void (__stdcall *Interface_Editor)(std::string, bool&, std::string&);

//-----------------------------------------------------------------------------
class RelativeItemDelegate: public QStyledItemDelegate
{
    Q_OBJECT

public:

    RelativeItemDelegate(QObject *parent=0) : QStyledItemDelegate(parent)
    {
...
//-----------------------------------------------------------------------------
class RELATIVE_PCRSHARED_EXPORT Relative_PCR: public QObject, public Test_Interface
{
    Q_OBJECT
...
private:
    ...
    RelativeItemDelegate *quality_Delegate;

    QGroupBox *group_Standarts;         //Standarts (Control)
